public class Solution_7_2 : ISolution
{
    public void run()
    {
        ...
        var spaceToBeFreed = 30000000 - (70000000 - baseFolder.Size);
        var result = baseFolder.GetAllFoldersAsList()
                               .Where(f => f.Size >= spaceToBeFreed)
                               .OrderBy(f => f.Size)
                               .First()
                               .Size;

        Console.WriteLine($"done! First: {result}");
    }   
